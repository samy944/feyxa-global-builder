...
const statusColors: Record<string, string> = {
  ...
  packed: "bg-orange-500/10 text-orange-400",
    ...
    <MarketLayout>
      <section className="py-12">
        <div className="container max-w-3xl">
          ...
          <h1 className="font-heading text-3xl text-foreground mb-8">MES COMMANDES</h1>
          ...
          {loading ? (
            ...
            <div className="text-center py-20 space-y-3">
              ...
              <Link to="/market" className="text-primary text-sm">
                Découvrir le Market →
              </Link>
            </div>
          ) : (
                          ...
                          <Button
                            ...
                            onClick={() =>
                              setReviewTarget({
                                ...
                                storeId: (order.stores as any).id,
                                orderId: order.id,
                              })
                            }
